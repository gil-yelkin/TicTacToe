...
class Cursor(pygame.sprite.Sprite):
    def __init__(self, shape):
        ...
        if shape == 'cross':
            ...
            self.image = pygame.image.load('cross_cursor.png')\
                .convert_alpha()
        elif shape == 'circle':
            pygame.mouse.set_visible(False)
            self.image = pygame.image.load('circle_cursor.png')\
                .convert_alpha()
        else:
            raise TypeError
...
class GameBoard:
    def __init__(self):
        """
        This function initializes a GameBoard object which contains
        a pygame Group of cells (see class 'Cell), a surface and a
        rectangle.
        """
            ...
            if game_active:
                if event.type == pygame.MOUSEBUTTONDOWN:
                    ...
                    if board.rect.collidepoint(mouse_pos):
                        if not winner:
                            was_placed = place_shape(board, mouse_pos,
                                                     chosen_shape)
                ...
                if event.type == pygame.MOUSEBUTTONDOWN:
                    ...
                    if chosen_shape:
                        ...
                        if chosen_shape == 'circle':
                            easy_ai_place_shape(board, 'cross')
